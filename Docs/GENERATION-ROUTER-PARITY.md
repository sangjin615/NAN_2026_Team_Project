...
8판을 돌려 **PNT 를 6 → 65개**로 채웠다. 어미도 다섯 가지에 고르게 퍼졌다
(남아 있다 17 · 보인다 15 · 드러난다 14 · 확인된다 10 · 이어진다 9).

현재 깨끗한 문장 수 — CER 8 · CLK 10 · **PNT 65** · BOK 16 · MET 8 · JEW 10.
하루에 같은 카테고리가 최대 5개(40시드 × 12일 실측)이므로 예비까지 내려가는
일은 사실상 없지만, **MET·CER 8개는 여전히 얇다.** 같은 방법으로 채울 수 있다.
...
| 하루 평균 서로 다른 어미 | 2가지 | **4.19가지** |
| 계약 검증 실패 | 0 | **0 / 360일** |
| 다른 품목 이름 새어듦 | — | **0건 / 2,880 LOT** |
