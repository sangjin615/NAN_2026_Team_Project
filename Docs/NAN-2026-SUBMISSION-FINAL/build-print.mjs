...
const style = [
  ...
  '  font-size: 10.5pt; line-height: 1.72; word-break: keep-all; overflow-wrap: anywhere; }',
  // 표제는 게임 타이틀과 같은 명조 계열로 둔다.
  'h1, h2, h3, .toc-title { font-family: Batang, "Apple SD Gothic Neo", "Noto Serif KR", serif; }',
  'h1 { font-size: 21pt; letter-spacing: .02em; margin: 0 0 2mm; text-align: center; }',
  'h1 + p { margin: 0 0 6mm; text-align: center; color: var(--muted); font-size: 10pt; }',
  '.rule { border: 0; border-top: 2px solid var(--brass); margin: 0 0 1.2mm; }',
  '.rule + .rule { border-top: 1px solid var(--brass-soft); margin: 0 0 7mm; }',
  '.mark { text-align: center; color: var(--gold); font-size: 12pt; margin: 0 0 2mm; letter-spacing: .4em; }',
  'h2 { font-size: 14.5pt; margin: 9mm 0 3mm; padding-bottom: 1.6mm;',
  '  border-bottom: 1.5px solid var(--brass); break-after: avoid; }',
  'h3 { font-size: 12pt; margin: 6mm 0 2mm; color: #3a2f21; break-after: avoid; }',
  ...
  'th { background: var(--parch-deep); font-weight: 700; border-bottom: 1.5px solid var(--brass-soft); }',
