const steps = [
  { target: '#open-new-slots', title: '새 여정을 시작하세요', text: '처음 플레이한다면 새 게임을 눌러 저장 슬롯을 선택합니다.', action: true },
  { target: '#new-run', title: '저장 슬롯을 선택하세요', text: '빈 저장 슬롯을 고른 뒤 새 여정을 시작하세요. 진행 상황은 선택한 슬롯에 저장됩니다.', action: true },
  { target: '[data-scene="hub"] [data-place="catalog"]', title: '도시에서 경매장으로', text: '도시는 하루의 준비를 하는 곳입니다. 먼저 오늘의 경매품을 확인하러 가세요.', action: true },
  { target: '#catalog-grid', title: '오늘의 경매품 확인', text: '책자에는 오늘 등장할 8개 물품의 이름, 등급, 계열과 기준가가 표시됩니다.' },
  { target: '#start-auction', title: '경매를 시작하세요', text: '준비가 끝났다면 경매 시작을 눌러 첫 물품의 경매에 참가하세요.', action: true },
  { target: '[data-scene="auction"] > header', title: '물품 정보를 확인하세요', text: '상단에서 물품 이름과 계열을, 중앙 카드에서 등급과 기준가를 확인할 수 있습니다.' },
  { target: '[data-scene="auction"] > .actions', title: '호가하거나 패스하세요', text: '5%·10%·20% 호가, 직접 입력 또는 패스를 선택할 수 있습니다. 현재 자산을 넘지 않도록 주의하세요.' },
];
